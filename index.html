...
<body class="bg-light">
      ...
      <div class="g-5">
        <table class="table table-striped">
          <thead class="thead-light">
            ...
            <button type="button" class="btn btn-info" data-bs-toggle="modal" data-bs-target="#modalSV">
              Add Students
            </button>
            <!-- Modal -->
            <!-- <div class="modal" id="modalSV" tabindex="-1"> -->
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  ...
                  <div class="mb-3 row">
                    <label for="txtMSSV" class="col-sm-2 col-form-label">MSSV:</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="txtMSSV" placeholder="Nhập MSSV">
                    </div>
                  </div>
                  ...
                  <div class="mb-3 row">
                    <label for="txtLop" class="col-sm-2 col-form-label">Lớp:</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="txtLop">
                    </div>
                  </div>

                  <div class="mb-3 row">
                    <label for="txtLop" class="col-sm-2 col-form-label">Giới tính:</label>
                    <div class="col-sm-10">
  ...
  <footer class="my-5 pt-5 text-muted text-center text-small">
    <p class="mb-1">&copy; 2022–2023 Thiết kế web nâng cao</p>
